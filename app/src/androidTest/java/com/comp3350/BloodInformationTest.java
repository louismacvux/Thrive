...
public class BloodInformationTest {
    ...
    public void setUp() throws Exception {
        ...
        User testUser1 = new User("maleTestUser", "maleTestUser@email.com", 25, 170.5, "Male", 178, "123456");
        dbHelper.addData(testUser1);
    }

    @After
    public void tearDown() {
        dbHelper.removeUser("maleTestUser");
    }

    @Test
    public void testSuggestionDocs() {
        //login
        onView(withId(R.id.edittext_username)).perform(typeText("maleTestUser"));
        ...
        //check all the pdfs
        onView(withId(R.id.tsh_low_sugg)).perform(click());
        ...
        pressBack();
        onView(withId(R.id.tsh_high_sugg)).perform(click());
        onView(withId(R.id.pdfView)).check(matches(isCompletelyDisplayed()));
